...
?>
        ...
        <div class="conteudo">
            <div class="container">
                <div class="row">
                    <h1 style="font-weight: bolder">TROCA DE SENHA</h1>
                ...
                <form action="reconfigurarsenha.php" method="POST">
                    <div class="row row-cols-3">
                        <div class="col-6">
                            <div class="user-box">
                                ...
                                <input type="password" name="senhaold" required="true" style="margin-left:0;">
                    ...
                    <div class="row row-cols-3">
                        <div class="col-6">
                             <div class="user-box">
                                <input type="password" name="senhanova" required="true" style="margin-left:0;">
