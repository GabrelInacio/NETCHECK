...
<head>
        ...
        <title>NetCheck - Admin</title>
    </head>
    <body>
        <div class="topo">
            <div class="d-flex bd-highlight align-items-center">
                <div class="me-auto p-2 bd-highlight">
                    <img src="../../styles/logos/logo-admin.png">
                </div>
        ...
        <div class="menu">
            ...
            <a href="addadmin.php" class="item"><i class="fas fa-plus"></i><span style="font-size:2rem">ADICIONAR ADMIN</span></a>
            <a href="usuarios.php" class="item"><i class="fas fa-users"></i><span style="font-size:2rem">USUÁRIOS</span></a>
        </div>
