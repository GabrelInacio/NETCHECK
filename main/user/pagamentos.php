                ...
                <div class="row">
                    <div class="col modcard" style="background-color: #DC3338;">
                        ...
                        <div class="row d-flex justify-content-end" style="margin-top: 1rem; margin-bottom: 1rem;">
                            <div class="col-3">
                                <a href="<?php echo 'deletacartao.php?cardid='.$cartao['id'];?>" class="botao3" style="padding-top:.5rem; padding-bottom:.5rem; padding-left:.5rem; padding-right:.5rem"><i class="fas fa-trash"></i>  REMOVER CARTÃO</a>
                            </div>
                        </div>
                    </div>
                </div>
